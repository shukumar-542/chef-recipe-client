            ...
            <div className=''>
                <div className='flex flex-col px-10  lg:flex-row my-container lg:justify-between space-y-5 items-center mb-10 '>
                    <div className='space-y-4 text-center lg:text-left'>
                        <h1 className='font-extrabold text-5xl lg:w-1/2 text-orange-500'>Let's Start </h1>
                        <p className='text-gray-500 text-5xl font-bold'>Cooking With Popular Recipe </p>
